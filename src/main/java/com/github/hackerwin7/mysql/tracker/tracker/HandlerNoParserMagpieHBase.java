...
public class HandlerNoParserMagpieHBase implements MagpieExecutor {
    ...
    //constructor
    public HandlerNoParserMagpieHBase(TrackerConfiger configer) {
    ...
    private void writeHBaseEvent() throws IOException {
        ...
        for(LogEvent event : eventList){
            ...
            try {
                ...
                logger.error("parse to entry failed!!!" + " msg : " + e.getMessage());
                e.printStackTrace();
            }
            ...
            if(entry!=null) {
                ...
                //avro serialize
                byte[] entryBytes = getBytesFromEntryToAvro(entry);
